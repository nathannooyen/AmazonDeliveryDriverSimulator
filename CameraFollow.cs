...
//     Name it exactly "CameraFollow".
//
//  2. Attach it to your Main Camera GameObject.
//
//  3. In the Inspector, drag your car GameObject into the
//     "Target" field.
//
//  4. RECOMMENDED SETTINGS:
//     - Smooth Speed       : 5  (higher = tighter follow)
//     - Offset             : (0, 0, -10)  — Z must be negative
//     - Follow Rotation    : true
//     - Rotation Smooth    : 4
//     - Min Speed To Rotate: 0.5
//     - Look Ahead Distance: 1.5
//
//  5. The camera requires NO additional components — just this
//     script and the built-in Camera component.
// ============================================================
